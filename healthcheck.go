...
// 		service := service
// 		log.Println("spawn goroutine for:", service.Service.Name)

// 		go func() {
// 			defer wg.Done()

// 			log.Println("ENTER HEALTHCHECK:", service.Service.Name)

// 			health := h.getServiceHealth(ctx, service)

// 			log.Println("EXIT HEALTHCHECK:", service.Service.Name, health.Status)
// 		}()
// 	}
// 	// for _, service := range services {
...
// 		log.Default().Print("------------service.Service is NIL")
// 		return status
// 	}
